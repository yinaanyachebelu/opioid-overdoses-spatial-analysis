...
```{r local_auto, fig.height = 5, fig.width=5, results='hide', message=FALSE, warning=FALSE}
...
```{r fig.height=4, fig.width=7,results='hide', message=FALSE, warning=FALSE}
...
```{r fig.height=5, fig.width=9,results='hide', message=FALSE, warning=FALSE}
...
- why we pick GWPR; how the city can target the west effectively based on the results.
