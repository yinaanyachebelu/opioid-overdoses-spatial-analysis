...
```{r setup, echo=FALSE, results='hide', message=FALSE, warning=FALSE, include=TRUE}
...
maricopa_crs <- 'EPSG:2223'
mesa_dataset<- st_read("../mesa_complete_data3.geojson")%>%st_transform(st_crs(maricopa_crs))
...
```{r vars_maps, fig.height=7, fig.width=7, echo=FALSE, message=FALSE, warning=FALSE}
...
mapTheme<- function(base_size = 20, title_size = 25) {
  theme(
...
```{r corr_ov, fig.height=6.5, fig.width=5.5, echo=FALSE, message=FALSE, warning=FALSE}
