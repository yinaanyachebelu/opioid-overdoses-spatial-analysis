...
***Figure 13: Residual spatial dependance from OLS model***

```{r message=FALSE, warning=FALSE}
lm.morantest(preg, mesa_weights, zero.policy=TRUE)
```

***Figure 14: Residual spatial dependance from Poisson regression model****
